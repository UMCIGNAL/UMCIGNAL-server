...
import { addIdleTypeService, findIdleTypeService, fixIdleTypeService, rerollService } from "../idleType.service/idleType.service";
...
export const rerollController = async (
    req : Request,
    res : Response,
    next : NextFunction
): Promise<any> => {
